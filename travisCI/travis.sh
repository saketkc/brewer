...
options=( "--with-java-modular" "--with-lua-modular" "--with-lua-static" "--with-matlab-static" "--with-octave-modular" "--with-octave-static" "--with-python-modular" "--with-python-static" "--with-r-modular" "--with-r-static" "--with-tests" "--with-brewed-matplotlib" "--with-brewed-numpy")
